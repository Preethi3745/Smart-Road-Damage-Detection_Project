"""
Smart Road Damage Detection (Beginner Level - OpenCV)
--------------------------------------------------------
This is a SIMPLE, beginner-friendly project that detects possible
road damage (cracks / potholes) in an image using classic OpenCV
image-processing techniques -- NO machine learning / deep learning.

How it works (step by step):
    1. Load the road image.
    2. Convert it to grayscale (easier to process, one color channel).
    3. Blur the image slightly to remove noise.
    4. Use Canny Edge Detection to find edges (cracks have lots of edges).
    5. Use thresholding + contours to find dark, irregular blobs (potholes).
    6. Draw boxes around anything that looks like "damage" and save
...
Usage:
    python road_damage_detection.py --image road1.jpg
    (If you don't pass --image, it will look for "sample_road.jpg")
"""
